...
The project integrates UI design, backend logic, database modeling, and agile project management using Jira.
...
Two agile approaches applied:

Kanban for continuous task flow

Scrum with sprint-based delivery
...
Work items cannot transition to Done unless:

All linked test tasks are completed

Required subtasks are resolved
